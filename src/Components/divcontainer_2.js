...
import './divcontainer_2.css'
import ImgAsset from '../public'
export default function Divcontainer_2 () {
	return (
		<div className='divcontainer_2_divcontainer'>
				...
				<div className='Link'>
					<div className='divsmallfont'>
						...
						<div className='_64a6cdff000962bbfb4a9cb8_underlinegreensvg'>
							<img className='Vector' src = {ImgAsset.divcontainer_2_Vector} />
						</div>
					</div>
			...
			<div className='divshowcaselooping'>
				<div className='divshowcaserow'>
					...
					<div className='divcard_1'>
						...
						<img className='Star1' src = {ImgAsset.divcontainer_2_Star1} />
					</div>
					<div className='divcard_2'>
						...
						<img className='Star1_1' src = {ImgAsset.divcontainer_2_Star1_1} />
					</div>
					<div className='divcard_3'>
						...
						<img className='Star1_2' src = {ImgAsset.divcontainer_2_Star1_2} />
					</div>
				</div>
				...
				<div className='divshowcaserow_1'>
					...
					<div className='divcard_5'>
						...
						<img className='Star1_3' src = {ImgAsset.divcontainer_2_Star1_3} />
					</div>
					<div className='divcard_6'>
						...
						<img className='Star1_4' src = {ImgAsset.divcontainer_2_Star1_4} />
					</div>
					<div className='divcard_7'>
						...
						<img className='Star1_5' src = {ImgAsset.divcontainer_2_Star1_5} />
					</div>
					<div className='divcard_8'>
						...
						<img className='Star1_6' src = {ImgAsset.divcontainer_2_Star1_6} />
					</div>
					<img className='divgradienttop' src = {ImgAsset.divcontainer_2_divgradienttop} />
				</div>
